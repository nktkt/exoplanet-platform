"""Alembic environment for the exoplanet_platform storage schema.

This file is deliberately minimal: it consults application settings for the
database URL and points Alembic at `models.Base.metadata` for autogeneration.
"""
...
# Override sqlalchemy.url from application settings so we have one source of truth.
